...
const BLOCK_EXPLORER_PREFIXES: { [chainId: number]: string } = {
  ...
  [SupportedChainId.ZKSYNC_TESTNET]: 'https://goerli.explorer.zksync.io',
  [SupportedChainId.ZKSYNC_MAINNET]: 'https://explorer.zksync.io',
  [SupportedChainId.BASE_TESTNET]: 'https://goerli.basescan.org',
  [SupportedChainId.BASE_MAINNET]: 'https://basescan.org',
  [SupportedChainId.OPBNB_TESTNET]: 'https://testnet.opbnbscan.com',
  [SupportedChainId.OPBNB_MAINNET]: 'https://opbnbscan.com',
}
...
export function getOKLink(txhash: string) {
  return `https://www.oklink.com/zksync/tx/${txhash}`
}
