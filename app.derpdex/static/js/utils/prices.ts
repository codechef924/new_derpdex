...
export function get1inchPriceImpactWarning(priceImpact1inch: number): 'warning' | 'error' | undefined {
  if (priceImpact1inch > 50) return 'error'
  if (priceImpact1inch > 10) return 'warning'
  return
}
