...
export default function GenesisPoolDetailsV2() {
  ...
  return (
    <Trace page="genesis-pool-details" shouldLogImpression>
      <PageWrapper>
        <AutoColumn gap="sm">
          <Link
            data-cy="visit-genesis-pools"
            style={{ textDecoration: 'none', width: 'fit-content', marginBottom: '0.5rem' }}
            to={`/extended-genesis-pools/${returnPath}`}
          >
            <HoverText onMouseOver={() => setColor('black')} onMouseLeave={() => setColor('white')}>
              <Trans>
                <BackToIcon fill={color} />{' '}
                <NunitoText size="lg" weight={700}>
                  Back to Extended Genesis Pools
                </NunitoText>
              </Trans>
            </HoverText>
          </Link>
