...
import { sortAscendingAtom, sortMethodAtom, TopWinnerSortMethod, useSetSortMethod } from './state'
...
const HEADER_DESCRIPTIONS: Record<TopWinnerSortMethod, ReactNode | undefined> = {
  [TopWinnerSortMethod.PNL]: undefined,
  [TopWinnerSortMethod.REWARDS]: <Trans>USD value of DERP points</Trans>,
}
...
function HeaderCell({
  ...
  category: TopWinnerSortMethod // TODO: change this to make it work for trans
}) {
...
export function TopWinnerHeaderRow() {
  return (
    <TopWinnerRow
      header={true}
      walletAddress={<Trans>Wallet Address</Trans>}
      pnl={<HeaderCell category={TopWinnerSortMethod.PNL} />}
      rewards={<HeaderCell category={TopWinnerSortMethod.REWARDS} />}
    />
  )
}
  ...
  return (
    <div ref={ref} data-testid={`list-table-row-${record.walletAddress}`}>
      <TopWinnerRow
        ...
        rankInfo={
          record.index === 1 ? (
            <img src={DerpTrading1} alt="derp-winner-1" width="50" height="50" style={{ marginRight: '5px' }} />
          ) : record.index === 2 ? (
            <img src={DerpTrading2} alt="derp-winner-2" width="50" height="50" style={{ marginRight: '5px' }} />
          ) : record.index === 3 ? (
            <img src={DerpTrading3} alt="derp-winner-3" width="50" height="50" style={{ marginRight: '5px' }} />
          ) : record.index > 3 ? (
