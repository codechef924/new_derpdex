...
`
export default function GenesisPoolV2() {
  return (
    <Trace page="genesis-pools" shouldLogImpression>
      <PageWrapper>
        <FlexContainerBetween>
          <TitleContainerBase>
            <Trans>
              <Title>Extended Genesis Pools</Title>
            </Trans>
          </TitleContainerBase>
          <SubTitleContainerBase>
            <Trans>
              <SubTitle>
                Extended Genesis Pools is an extended campaign to allow more rewards distribution for users to earn
                tokens from the protocol. <br /> <br />{' '}
                <b
                  style={{
                    margin: 'auto',
                    display: 'block',
                ...
                >
                  Earn up to $40,000 airdrop allocation. No lock, withdraw anytime!
                </b>
              </SubTitle>
            </Trans>
          </SubTitleContainerBase>
