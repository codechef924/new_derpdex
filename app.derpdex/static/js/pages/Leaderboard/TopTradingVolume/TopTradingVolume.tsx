...
import DerpBoss from 'assets/images/derp-boss.png'
...
export function TopTradingVolume(props: TopTradingVolumeProps) {
  ...
  return (
    <Wrapped>
      <TopHeader>
        <Img src={DerpBoss} alt="derp-boss" />
        <TableTitle>
          <Trans>Top Trading Volume</Trans>
        </TableTitle>
      </TopHeader>
