...
import { FarmingfilterStringAtom } from '../state/search.state'
...
const DerpSearchInput = styled.input`
  background: no-repeat scroll 7px 7px;
  background-image: url(${searchIcon});
  background-size: 13.97px 14px;
  ...
  :focus {
    outline: none;
    background-color: ${({ theme }) => theme.backgroundSurface};
    border-color: ${({ theme }) => theme.derpGray1};
  }
...
export default function SearchBar() {
  ...
  const setFilterString = useUpdateAtom(FarmingfilterStringAtom)
