import { Pool, Route } from '@derpdex/sdk'
...
export function useAllV3RoutesByLimitPath(
  currencyIn?: Currency,
  currencyOut?: Currency,
  maxPath?: number
): { loading: boolean; routes: Route<Currency, Currency>[] } {
  ...
  return useMemo(() => {
    ...
    const routes = computeAllRoutes(currencyIn, currencyOut, pools, chainId, [], [], currencyIn, maxPath)
    return { loading: false, routes }
  }, [chainId, currencyIn, currencyOut, pools, poolsLoading])
}
