...
export const TOKEN_SAFETY_ARTICLE = 'https://derpdex.com'
    ...
    switch (warning.level) {
      case WARNING_LEVEL.MEDIUM:
        heading = (
          <NunitoText weight={500}>
            <Plural
              value={plural ? 2 : 1}
              _1="This token is not verified by DerpDex. Token is potentially risky and highly volatile."
              other="These tokens are not verified by DerpDex. Tokens are potentially risky and highly volatile."
            />
          </NunitoText>
        )
        description = (
          <Trans>
            <NunitoText weight={500}>Always conduct your own research before trading.</NunitoText>
          </Trans>
        )
        break
      ...
      case WARNING_LEVEL.BLOCKED:
        description = (
          <Plural
            value={plural ? 2 : 1}
            _1="You can't trade this token using the DerpDeX App."
            other="You can't trade these tokens using the DerpDeX App."
          />
        )
        break
    }
