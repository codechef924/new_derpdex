...
export const USDC_ZKSYNC_TESTNET = new Token(
...
// eslint-disable-next-line import/no-unused-modules
export const WBTC_ZKSYNC_TESTNET = new Token(
  SupportedChainId.ZKSYNC_TESTNET,
  '0xE6E3854A3dF24043890BB5376DEbFA178C56a011',
  8,
  'WBTC',
  'WBTC'
)
...
export const USDC_ZKSYNC_MAINNET = new Token(
...
export const WBTC_ZKSYNC_MAINNET = new Token(
  SupportedChainId.ZKSYNC_MAINNET,
...
export const USDC_BASE_TESTNET = new Token(
  ...
  '0x2a337c269e74af16d5a608956b675ade882220f3', //!TBU
  6,
  'USDC',
  'USD Coin'
)
...
export const USDC_BASE_MAINNET = new Token(
  ...
  '0xd9aaec86b65d86f6a7b5b1b0c42ffa531710b6ca', // Checked and verified
  6,
  'USDbC',
  'USDC (Bridged)'
)

export const USDT_OPBNB_TESTNET = new Token(
  SupportedChainId.OPBNB_TESTNET,
  '0x5461A9dBeA2F5eFa771a2d6F8F78bC589d4Bb0D7', // Checked and verified
  6,
  'USDT',
  'USDT'
)

export const USDT_OPBNB_MAINNET = new Token( // TBU
  SupportedChainId.OPBNB_MAINNET,
  '0x9e5aac1ba1a2e6aed6b32689dfcf62a509ca96f3', // Checked and verified
  18,
  'USDT',
  'USDT'
)
...
export const WRAPPED_NATIVE_CURRENCY: { [chainId: number]: Token | undefined } = {
  ...
  [SupportedChainId.BNB_TESTNET]: new Token(
  ...
  [SupportedChainId.ZKSYNC_TESTNET]: new Token(
    SupportedChainId.ZKSYNC_TESTNET,
    '0xC3ec043C150c945652A09D7E47F856AC9fB0F893',
    18,
    'WETH',
    'Wrapped Ether'
  ),
  [SupportedChainId.ZKSYNC_MAINNET]: new Token(
    SupportedChainId.ZKSYNC_MAINNET,
  ...
  [SupportedChainId.BASE_TESTNET]: new Token(
    SupportedChainId.BASE_TESTNET,
    '0x4200000000000000000000000000000000000006',
    18,
    'WETH',
  ...
  [SupportedChainId.BASE_MAINNET]: new Token(
    SupportedChainId.BASE_MAINNET,
    '0x4200000000000000000000000000000000000006',
    18,
    'WETH',
  ...
  [SupportedChainId.OPBNB_TESTNET]: new Token(
    SupportedChainId.OPBNB_TESTNET,
    '0x4200000000000000000000000000000000000006', // !TBU
    18,
    'WBNB',
    'Wrapped BNB'
  ),
  [SupportedChainId.OPBNB_MAINNET]: new Token(
    SupportedChainId.OPBNB_MAINNET,
    '0x4200000000000000000000000000000000000006',
    18,
    'WBNB',
...
export function isZkSync(
  chainId: number
): chainId is SupportedChainId.ZKSYNC_MAINNET | SupportedChainId.ZKSYNC_TESTNET {
  return chainId === SupportedChainId.ZKSYNC_MAINNET || chainId === SupportedChainId.ZKSYNC_TESTNET
}

export function isBase(chainId: number): chainId is SupportedChainId.BASE_MAINNET | SupportedChainId.BASE_TESTNET {
  return chainId === SupportedChainId.BASE_MAINNET || chainId === SupportedChainId.BASE_TESTNET
}

export function isOpBNB(chainId: number): chainId is SupportedChainId.OPBNB_MAINNET | SupportedChainId.OPBNB_TESTNET {
  return chainId === SupportedChainId.OPBNB_MAINNET || chainId === SupportedChainId.OPBNB_TESTNET
}

export function isBNB(chainId: number): chainId is SupportedChainId.BNB | SupportedChainId.BNB_TESTNET {
  return chainId === SupportedChainId.BNB || chainId === SupportedChainId.BNB_TESTNET
}
...
class opBNBNativeCurrency extends NativeCurrency {
  ...
  get wrapped(): Token {
    if (!isOpBNB(this.chainId)) throw new Error('Not bnb')
    const wrapped = WRAPPED_NATIVE_CURRENCY[this.chainId]
    invariant(wrapped instanceof Token)
    return wrapped
  }
...
export const TOKEN_SHORTHANDS: { [shorthand: string]: { [chainId in SupportedChainId]?: string } } = {
  USDC: {
    ...
    [SupportedChainId.ZKSYNC_TESTNET]: USDC_ZKSYNC_TESTNET.address,
    [SupportedChainId.ZKSYNC_MAINNET]: USDC_ZKSYNC_MAINNET.address,
    [SupportedChainId.BASE_TESTNET]: USDC_BASE_TESTNET.address,
