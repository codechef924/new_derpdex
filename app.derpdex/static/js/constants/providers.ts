...
export const RPC_PROVIDERS: { [key in SupportedChainId]: StaticJsonRpcProvider } = {
  ...
  [SupportedChainId.ZKSYNC_TESTNET]: new AppJsonRpcProvider(SupportedChainId.ZKSYNC_TESTNET),
  [SupportedChainId.ZKSYNC_MAINNET]: new AppJsonRpcProvider(SupportedChainId.ZKSYNC_MAINNET),
  [SupportedChainId.BASE_TESTNET]: new AppJsonRpcProvider(SupportedChainId.BASE_TESTNET),
  [SupportedChainId.BASE_MAINNET]: new AppJsonRpcProvider(SupportedChainId.BASE_MAINNET),
  [SupportedChainId.OPBNB_TESTNET]: new AppJsonRpcProvider(SupportedChainId.OPBNB_TESTNET),
  [SupportedChainId.OPBNB_MAINNET]: new AppJsonRpcProvider(SupportedChainId.OPBNB_MAINNET),
}
