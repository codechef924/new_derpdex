...
import bnbLogoBlackWhite from 'assets/svg/bnb-logo-bw.svg'
import celoLogo from 'assets/svg/celo_logo.svg'
import celoSquareLogoUrl from 'assets/svg/celo_square_logo.svg'
import ethereumLogoUrl from 'assets/svg/ethereum-eth-logo.svg'
...
import zkSyncLogo from 'assets/svg/zksync_logo.svg'
...
const CHAIN_INFO: ChainInfoMap = {
  ...
  [SupportedChainId.ZKSYNC_TESTNET]: {
    ...
    infoLink: 'https://info.derpdex.com/#/zksync-testnet/',
    label: 'ZkSync Testnet',
    logoUrl: zkSyncLogo,
    nativeCurrency: { name: 'ZkSync Testnet ETH', symbol: 'ETH', decimals: 18 },
    color: darkTheme.chain_280,
    defaultListUrl: ZKSYNC_TESTNET_LIST,
  },
  [SupportedChainId.ZKSYNC_MAINNET]: {
    ...
    infoLink: 'https://info.derpdex.com/#/zksync/',
    label: 'ZkSync Mainnet',
    logoUrl: zkSyncLogo,
    nativeCurrency: { name: 'ZkSync Mainnet ETH', symbol: 'ETH', decimals: 18 },
    color: darkTheme.chain_280,
    defaultListUrl: ZKSYNC_MAINNET_LIST,
  },
  [SupportedChainId.BASE_TESTNET]: {
    ...
    infoLink: 'https://info.derpdex.com/#/base/',
    label: 'Base Testnet',
    logoUrl: baseLogo,
    nativeCurrency: { name: 'Base Testnet ETH', symbol: 'ETH', decimals: 18 },
    color: darkTheme.chain_8453,
    defaultListUrl: BASE_TESTNET_LIST,
  },
  [SupportedChainId.BASE_MAINNET]: {
    ...
    label: 'Base Mainnet',
    logoUrl: baseLogo,
    nativeCurrency: { name: 'Base Mainnet ETH', symbol: 'ETH', decimals: 18 },
    color: darkTheme.chain_8453,
    defaultListUrl: BASE_MAINNET_LIST,
  },
  [SupportedChainId.OPBNB_TESTNET]: {
    ...
    infoLink: 'https://info.derpdex.com/#/opbnb/',
    label: 'opBNB Testnet',
    logoUrl: bnbLogoBlackWhite,
    nativeCurrency: { name: 'BNB', symbol: 'BNB', decimals: 18 },
    color: darkTheme.chain_204,
    defaultListUrl: OPBNB_TESTNET_LIST,
  },
  [SupportedChainId.OPBNB_MAINNET]: {
    ...
    nativeCurrency: { name: 'BNB', symbol: 'BNB', decimals: 18 },
    color: darkTheme.chain_204,
    defaultListUrl: OPBNB_MAINNET_LIST, // TBU
  },
}
