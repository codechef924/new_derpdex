...
import { get1inchPriceImpactWarning, getPriceImpactWarning } from 'utils/prices'

import { ButtonError, DDButtonPrimary, SmallButtonPrimary } from '../Button'
            ...
            <DetailRowValue
              color={
                !aggregatorPriceImpact
                  ...
                  : get1inchPriceImpactWarning(aggregatorPriceImpact)
              }
            >
              {trade.priceImpact && !aggregatorPriceImpact ? formatPriceImpact(trade.priceImpact) : '-'}
              {aggregatorPriceImpact ? <>{aggregatorPriceImpact?.toFixed(2)}%</> : '-'}
            </DetailRowValue>
          </Row>
        </ThemedText.BodySmall>
        <ThemedText.BodySmall>
