...
import { AdvancedSwapDetailsMinimal } from './AdvancedSwapDetailMinimal'
...
export default function SwapDetailsDropdownMinimal({
  trade,
  syncing,
  loading,
  allowedSlippage,
  ...
  return (
    <Wrapper className={styles.OverrideStyledHeader}>
      <TraceEvent
      ...
      {trade && (
        <AnimatedDropdown open={showDetails}>
          <SwapDetailsWrapper data-testid="advanced-swap-details">
            <AdvancedSwapDetailsMinimal trade={trade} allowedSlippage={allowedSlippage} syncing={syncing} />
          </SwapDetailsWrapper>
        </AnimatedDropdown>
      )}
    </Wrapper>
