...
export function AdvancedSwapDetailsMinimal({ trade, allowedSlippage, syncing = false }: AdvancedSwapDetailsProps) {
  ...
  return (
    <Column gap="md">
      ...
      <RowBetween>
        ...
        <TextWithLoadingPlaceholder syncing={syncing} width={50}>
          <ThemedText.BodySmallNunito>{formatPriceImpact(trade.priceImpact)}</ThemedText.BodySmallNunito>
        </TextWithLoadingPlaceholder>
      </RowBetween>
      <RowBetween>
        <RowFixed>
