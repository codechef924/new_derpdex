...
export type SearchDerpDexToken = {
  exists: boolean
  address?: string
  feesUSD?: number
  name?: string
...
export const TokenRow = ({
  ...
  const tokenDetailsPath = getTokenDetailsURL({ address: token.address, chain, inputAddress: null })
