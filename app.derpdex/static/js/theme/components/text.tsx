...
export const ThemedText = {
  ...
  BodySmallNunito(props: TextProps) {
    return <NunitoText size="md2" weight={400} color="textPrimary" {...props} />
  },
  ...
  DeprecatedLabelNunito(props: TextProps) {
    return <NunitoText size="md2" weight={600} color="textPrimary" {...props} />
  },
  ...
  DerpGrayV1(props: TextProps) {
    return <TextWrapper fontWeight={700} color="derpGray1" {...props} />
  },
  DerpWhite(props: TextProps) {
    return <TextWrapper fontWeight={700} color="white" {...props} />
  },
  DerpBlack(props: TextProps) {
    return <TextWrapper fontWeight={700} color="black" {...props} />
  },
}
